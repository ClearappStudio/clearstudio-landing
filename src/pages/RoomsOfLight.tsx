...
export default function RoomsOfLight() {
  ...
  return <article ref={rootRef} className="rol-v11">
    ...
    <section ref={thresholdRef} className="threshold"><p className="eyebrow">Digital Art Gallery · Exhibition 01 · 2026</p><h1><span>Rooms</span><span>of Light</span></h1><div className="threshold-bottom"><p className="threshold-lead">Eight studies on light, space and the quiet transformations between them.</p><p className="threshold-copy">Across eight works, imagined rooms gradually move away from architecture and towards something less certain — spaces somewhere between memory, abstraction and possibility.</p><span className="enter-cue">Scroll to enter</span></div></section>
